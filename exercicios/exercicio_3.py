...
# Verifique quantos produtos formam boas combinações, ou
# seja, quando um produto é igual ao outro e seu índice é
# maior que o anterior. Esta combinação pode ser utilizada
# para modificar os produtos de uma página. Por exemplo:

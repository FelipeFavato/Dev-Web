...
# print(conjunto_a) -> saida {0, 'elemento', 3, 5}
...
# print(conjunto_a) -> saida {3, 'elemento', 5}

# clear() remove todos os itens do set
conjunto_b.clear()
# print(conjunto_b) -> saida set()
